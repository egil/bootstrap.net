...
{
    public sealed class Carousel2<TItem> : ComponentBase, IChildTrackingParentComponent
    {
        ...
        {
            throw new InvalidChildContentException($"When using a {nameof(Carousel2<TItem>)} in static content mode, " +
