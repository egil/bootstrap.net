...
namespace Egil.BlazorComponents.Bootstrap.Grid.Parameters
{
    ...
    public abstract class ColAlignmentParameter : Parameter
    {
        protected const string OptionPrefix = "align-self";

        public static implicit operator ColAlignmentParameter(AlignmentOption option)
        {
            return new OptionParameter(option);
        }

        public static implicit operator ColAlignmentParameter(OptionSet<IAlignmentOption> set)
        {
            return new OptionSetParameter(set);
        }

        public static readonly ColAlignmentParameter None = new NoneParameter();

        class OptionParameter : ColAlignmentParameter
        {
            private readonly IOption option;
        ...
        class OptionSetParameter : ColAlignmentParameter
        {
            private readonly IOptionSet<IOption> set;
        ...
        class NoneParameter : ColAlignmentParameter
        {
            public override int Count => 0;
