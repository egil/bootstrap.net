...
namespace Egil.RazorComponents.Bootstrap.Utilities
{
    ...
    {
        internal static Task PreventDefault(this ElementReference element, IJSRuntime? jsRuntime, string eventType)
        {
        ...
        internal static Task AllowDefault(this ElementReference element, IJSRuntime? jsRuntime, string eventType)
        {
            if (jsRuntime is null) throw new ArgumentNullException(nameof(jsRuntime));
