...
namespace Egil.RazorComponents.Bootstrap.Tests.TestUtilities
{
    ...
    {
        public static void ShouldContainOptionsWithPrefix(this ParameterBase parameter, string prefix, int number)
        {
            parameter.ShouldContainOptionsWithPrefix(prefix, (Number)number);
        }

        public static void ShouldContainOptionsWithPrefix(this ParameterBase parameter, string prefix, IOption option)
        {
            parameter.Single().ShouldBe($"{prefix}{Option.OptionSeparator}{option.Value}");
            parameter.Count.ShouldBe(1);
        }

        public static void ShouldContainOptionsWithPrefix(this ParameterBase parameter, string prefix, IOptionSet<IOption> set)
        {
